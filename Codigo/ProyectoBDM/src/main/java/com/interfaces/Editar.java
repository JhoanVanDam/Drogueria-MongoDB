...
public class Editar extends javax.swing.JFrame {
    ...
    private void EditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditarMouseClicked
        ...
        Seleccion = this.seleccionar(this.choice1.getSelectedItem());
        System.out.println(Seleccion + "olaaa");

        try {

            if (Nombre.isEmpty() == false && Seleccion != null) {

                this.metdb.EditarProducto(Seleccion, this.txtEdit.getText(), this.txtNombre.getText());
    ...
    public String seleccionar(String Seleccion) {
        switch (Seleccion) {
            case "":
                ...
                break;
            case "Nombre":
                Seleccion = "prod_descripcion";
                break;
            case "Costo":
                Seleccion = "prod_costo";
                break;
            case "Venta":
                Seleccion = "prod_venta";
                break;
            case "Cantidad":
                Seleccion = "prod_cantidad";
                break;
            case "Fecha de vencimiento":
                Seleccion = "prod_fechavencimiento";
                break;
        }
        return Seleccion;
    }
