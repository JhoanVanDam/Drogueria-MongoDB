...
public class Insertar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelVender.add(Agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 420, 50, 50));
        ...
        PanelVender.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 490, -1, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        jLabel8.setText("Ingrese la fecha de caducidad");
        PanelVender.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 330, -1, -1));
    ...
    private void AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AgregarMouseClicked
        ...
        try {
            if (txtCosto.getText().isEmpty() == false
                    && txtValor.getText().isEmpty() == false
                    && txtCantidad.getText().isEmpty() == false
                    && txtNombre.getText().isEmpty() == false) {
                this.metdb.InsertatProducto(this.txtNombre.getText(), this.txtCosto.getText(), this.txtValor.getText(), this.txtCantidad.getText(), this.txtFecha.getText());
            ...
            System.out.println("Error en agregar mouse "+ e);
             this.Errordatosincorrectos.setVisible(true);
        }
